...
import {EulerCompounderStrategyAprOracle as StrategyAprOracle} from "../periphery/StrategyAprOracle.sol";

contract OracleTest is Setup {
    StrategyAprOracle public oracle;

    address vaultLens = 0x0058F402aaa67868A682DA1bDd2E08c7aA3795eE;

    function setUp() public override {
        super.setUp();
        oracle = new StrategyAprOracle(vaultLens, strategy.REUL(), management);
    }
    ...
    //
    //         StrategyAprOracle.RewardCampaign[]
    //             memory _campaigns = new StrategyAprOracle.RewardCampaign[](2);
    //         _campaigns[0] = StrategyAprOracle.RewardCampaign({
    //             startTime: uint64(block.timestamp - 15 days),
    //             endTime: uint64(block.timestamp + 15 days),
    //             amount: 3332920000000000000000
    //         });
    //         _campaigns[1] = StrategyAprOracle.RewardCampaign({
